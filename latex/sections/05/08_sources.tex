\section{Recursos principals del bloc Fonts de Dades}
    ...
    \input{./sections/05/05_sources/01_collection}
    \input{./sections/05/05_sources/02_collectionContent}
    \input{./sections/05/05_sources/03_attribution}
    \input{./sections/05/05_sources/04_sourceDescription}
    \input{./sections/05/05_sources/05_sourceReference}
