\chapter{Introducció a l'aplicació web}
    ...
    \input{./sections/10/01_access}
    \input{./sections/10/02_requisits}
    \input{./sections/10/03_webStructure}
    \input{./sections/10/04_codeFiles}
    \input{./sections/10/05_appWorkflow}
    \input{./sections/10/06_implDetails}
    \input{./sections/10/07_certification}
    \input{./sections/10/08_googleAnalytics}
    \input{./sections/10/09_optimization}
    \input{./sections/10/10_hosting}
