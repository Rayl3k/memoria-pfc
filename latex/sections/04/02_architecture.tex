\section{L'arquitectura de l'\gls{API}}
    ...
    Les arquitectures \gls{REST} es caracteritzen per estar orientades en els recursos més que en les accions que es poden realitzar sobre ells i com a peculiaritat, es caracteritzen per sis regles o restriccions\footfullcite{whatIsRest}.
