...
<Note xmlns='...'>
    ...
    <attribution id='...'>
        ...
        \paragraph{}
        El llenguatge \gls{JSON}\footfullcite{wiki:json} és un estàndard de format obert que, de la mateixa forma que el llenguatge XML, pretén crear codificacions llegibles tant per éssers humans, com màquines i al mateix temps, poder transmetre aquestes dades a través del núvol de forma ordenada.
