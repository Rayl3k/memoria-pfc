\subsection{La tecnologia Node.js}
    ...
    Després de buscar, l'única tecnologia que complia amb les condicions que bus\-cà\-vem, era Node.js\footfullcite{nodeJS}. Node.js ha estat implementat com un model basat en esdeveniments sense interrupcions, el que el converteix en un sistema en temps d'execució lleuger i eficient.
