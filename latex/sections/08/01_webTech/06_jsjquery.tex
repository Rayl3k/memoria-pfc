\subsection{Les tecnologies Javascript i jQuery}
    ...
    Per altra banda, jQuery\footfullcite{jQuery} és una llibreria de Javascript plena de funcionalitats, dedicada a la manipulació de documents HTML, CSS i a la gestió de les comunicacions entre aquests i el servidor de les aplicacions web. Aquesta llibreria, s'ha convertit en un estàndard de la programació web i resulta indispensable de cara a crear aplicacions web funcionals i interactives.
