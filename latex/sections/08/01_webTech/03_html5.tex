\subsection{La tecnologia HTML 5}
    ...
    \paragraph{}
    La primera tecnologia que calia estudiar, si es volia implementar una pàgina web, era la tecnologia HTML i més concretament, el HTML 5\footfullcite{wiki:html5}.
