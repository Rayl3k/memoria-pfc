\section{Tecnologies pel desenvolupament de l'aplicació}
    ...
    \paragraph{}
    Com s'ha indicat en un apartat anterior, NPM\footfullcite{npm} és un contenidor de paquets orientats a la plataforma Node.js. Aquesta tecnologia pot ser instal·lada en l'àmbit local i d'aquesta forma, descarregar extensions per les aplicacions Node.js que vulguem utilitzar.
